...
import ria.Jun2015.textbooksharing.MainMenu;
...
public class ACT extends ListActivity {
  ...
  //JSON IDS:
   ...
   //An array of all of our comments
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				startActivity(new Intent(ACT.this, MainMenu.class));
    ...
    {
        Intent i = new Intent(ACT.this, BookSubmissionForm.class);
        startActivity(i);
    }
    ...
    public class LoadComments extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(ACT.this);
  ...
  /*  public void updateJSONdata() {
        ...
        try {
            ...
            for (int i = 0; i < mComments.length(); i++) {
                ...
                if(c.getString(TAG_BOOKTITLE).equals("ACT"))
                {
    ...
    /**
    	...
    	private void updateList() {
            ...
            map.put(TAG_BOOKTITLE, "act prep");
            map.put(TAG_BOOKTYPE, "ACT");
            map.put(TAG_NAME, "Ria");
            map.put(TAG_EMAIL, "riagarg@gmail.com");
            map1.put(TAG_BOOKTITLE, "act prep 2");
            map1.put(TAG_BOOKTYPE, "ACT");
            map1.put(TAG_NAME, "Ria");
            map1.put(TAG_EMAIL, "ria@gmail.com");
            map2.put(TAG_BOOKTITLE, "act prep");
            map2.put(TAG_BOOKTYPE, "ACT3");
            map2.put(TAG_NAME, "Ria");
            map2.put(TAG_EMAIL, "garg@gmail.com");
            mCommentList.add(map);
            mCommentList.add(map1);
            mCommentList.add(map2);
    		
    		ListAdapter adapter = new SimpleAdapter(this, mCommentList,
    				R.layout.single_submission, new String[] { TAG_BOOKTITLE,
    						TAG_NAME, TAG_EMAIL, TAG_BOOKTYPE }, new int[] { R.id.bookTitle, R.id.name,
    						R.id.email, R.id.bookType });
