...
public class SubjectSATChemistry extends ListActivity {
  ...
  //JSON IDS:
   ...
   //An array of all of our comments
    ...
    {
        Intent i = new Intent(SubjectSATChemistry.this, BookSubmissionForm.class);
        startActivity(i);
    }
    ...
    public class LoadComments extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(SubjectSATChemistry.this);
    ...
    public void updateJSONdata() {
        ...
        try {
            ...
            for (int i = 0; i < mComments.length(); i++) {
                ...
                if(c.getString(TAG_BOOKTYPE).equals("Subject SAT") && c.getString(TAG_BOOKTYPESUBCHOICE).equals("Chemistry"))
                {
