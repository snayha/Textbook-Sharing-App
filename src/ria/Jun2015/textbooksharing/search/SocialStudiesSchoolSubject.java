...
public class SocialStudiesSchoolSubject extends ListActivity {
  ...
  //JSON IDS:
   ...
   //An array of all of our comments
    ...
    {
        Intent i = new Intent(SocialStudiesSchoolSubject.this, BookSubmissionForm.class);
        startActivity(i);
    }
    ...
    public class LoadComments extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(SocialStudiesSchoolSubject.this);
    ...
    public void updateJSONdata() {
        ...
        try {
            ...
            for (int i = 0; i < mComments.length(); i++) {
                ...
                if(c.getString(TAG_BOOKTYPE).equals("School Subjects") && c.getString(TAG_BOOKTYPESUBCHOICE).equals("Social Studies"))
                {
