...
public class SubjectSATMath1 extends ListActivity {
  ...
  //JSON IDS:
   ...
   //An array of all of our comments
    ...
    {
        Intent i = new Intent(SubjectSATMath1.this, BookSubmissionForm.class);
        startActivity(i);
    }
    ...
    public class LoadComments extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(SubjectSATMath1.this);
    ...
    public void updateJSONdata() {
        ...
        try {
            ...
            for (int i = 0; i < mComments.length(); i++) {
                ...
                if(c.getString(TAG_BOOKTYPE).equals("Subject SAT") && c.getString(TAG_BOOKTYPESUBCHOICE).equals("Math 1"))
                {
